...
<div class="replyLi" >
   ...
   <div class="timeline-item" >
        <span class="time">
          ...
          <a class="btn btn-primary btn-xs {{rno}}-a" id="modifyReplyBtn" data-rno={{rno}} onclick="replyModifyModal_go('{{rno}}');" style="display:{{VisibleByLoginCheck replyer}};"
...
function replyRemove_go(){
      ...
      $.ajax({
         url:"<%=request.getContextPath()%>/replies/${board.bno}/${reply.rno}/"+replyPage,
         type:"DELETE",
         headers:{
